const { TestTemplate, TemplateParameter } = require('../models');

async function seedTemplates() {
  try {
    console.log('Starting test template seeding...');

    // Check if templates already exist
    const existingTemplates = await TestTemplate.count();
    ...
    for (const templateData of templates) {
      ...
      const template = await TestTemplate.create(templateInfo);
    ...
    console.log('✅ Test template seeding completed successfully!');
    console.log('\n📋 Created Templates:');
